...
def mot_main() :
	...
	while True:
		...
		right, left, left2 = (rl[0] & 4) >> 2, (rl[0] & 2)>>1, rl[0] & 1
		#print(right, left )
		
		if not right and not left and not left2:
			goForward()
		elif not right and left and left2:
			turnRight()
		elif right and not left and not left2:
			turnLeft()
		else:
			stopMotor()
